...
const headingVariants = cva("", {
  variants: {
    ...
    fontVariant: {
      degular: "font-[family-name:var(--font-degular)",
      degularlight: "font-[family-name:var(--font-degular-light)",
      degularvariable: "font-[family-name:var(--font-degular-variable)",
